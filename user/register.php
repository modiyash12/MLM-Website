...
if (isset($_GET["referid"])) {
  ...
  if (isset($_POST['submit'])) {
      ...
      $refer = mysqli_real_escape_string($conn,$_POST['refer']);
       ...
       $sql = "INSERT INTO `user` ( `name`, `email`, `mobileno`, `address`, `memberid`, `password`, `regdate`,`plan`, `state`,`refer`,`user_status`) VALUES ('$name','$email',$mobileno,'$address','$memberid','$password',now(),$plan, '$state' ,'$refer','PENDING' )";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">REGISTRATION (SILVER PLAN)</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
