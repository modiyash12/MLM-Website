<?php
  ...
  $password = mysqli_real_escape_string($conn, $_POST['password']);
    $cnfrmpassword = mysqli_real_escape_string($conn, $_POST['cnfrmpassword']);

    if ($password == $cnfrmpassword) {
        $sql="UPDATE `user` SET `password`='$password' WHERE `phoneno`='$mobile_number'";
        mysqli_query($conn,$sql);

        echo "<script>alert('PASSWORD SUCCESSFULLY UPDATED');document.location='userlogin.html'</script>";
    }
    else{
                echo "<script>alert('PASSWORD NOT MATCH');document.location='setpassword.php'</script>";
    ...
    -->
     ...
     <div class="login-box">
         ...
         <form action="setpassword.php" method="POST">
             ...
             <input type="text" name="cnfrmpassword" placeholder="CONFIRM PASSWORD" required />
