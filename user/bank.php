 ...
 <section class="content">
          ...
          <div class="col-lg-4 col-sm-4 col-md-4">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"> <?Php echo $a['accountno']; ?>0</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-lg-6 col-sm-6 col-md-4">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"> <?Php echo $a['phonepay']; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
      ...
      <div class="row">
          ...
          <div class="col-lg-6 col-sm-6 col-md-6">
            ...
            <a href="/amitbhai2/uploads/qr.png" download="qr.png"> <img src="/amitbhai2/admin/uploads/qr.png" style="height: 500px; width: 400px;"></a>
