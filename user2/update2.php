...
$name = mysqli_real_escape_string($conn,$_POST['name']);
      ...
      $state = mysqli_real_escape_string($conn,$_POST['state']);
            ...
            $sql = "UPDATE `user_g` SET `name`='$name',`email` ='$email',`mobileno`=$mobileno,`address` = '$address',`memberid`='$memberid',`password`='$password',`plan`=$plan,
...
if ($conn->query($sql) === TRUE) {
            ...
            echo "<script>alert('Unable to update record');document.location='update2.php'</script>";
            }
