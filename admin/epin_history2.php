   ...
   <div class="col-12 col-sm-6 col-md-12">
      ...
      <div class="card" style="margin-left: 10px;">
              <div class="card-header border-transparent">
                <h3 class="card-title">E-PIN HISTORY(GOLDEN PLAN)</h3>
    ...
    <th>STATUS</th>
                   ...
                   <?php
                    include('config.php');
                    $sql= "SELECT * FROM `pinrequest_g` WHERE `status`='close' or `status`='cancel'";
                    ...
                    if($result -> num_rows > 0){
                             while($row = $result ->fetch_assoc()){
                              ...
                              $sql_user=mysqli_query($conn,"SELECT `name` from `user_g` WHERE `memberid`='$memberid' LIMIT 1");
                              $result_user =mysqli_fetch_array($sql_user);

                              $img_address ="/amitbhai2/user2/receipt2/".$memberid.".png";
